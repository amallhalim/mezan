...
export default function Home() {
  ...
  return (
    <div
      className={`min-h-screen font-sans selection:bg-primary/30 transition-colors duration-500 ${
      ...
      <main className="relative max-w-7xl mx-auto px-6 py-12 lg:py-24">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <section className="bg-white/[0.03] backdrop-blur-xl border border-white/5 rounded-[2.5rem] p-8 space-y-8 hover:border-white/10 transition-all duration-500 shadow-2xl">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <label
                  htmlFor="username"
                  className="text-[10px] font-black uppercase text-gray-500 tracking-[0.15em] ml-1"
                >
                  Username
                </label>
                <input
          ...
          <div className="space-y-8">
            ...
            <section className="bg-white/[0.03] backdrop-blur-xl border border-white/5 rounded-[2.5rem] p-6 flex items-center justify-between">
              ...
              <div className="flex flex-col items-end">
                ...
                <span
                  ...
                  className="text-xs font-mono text-gray-400 bg-white/5 px-2 py-1 rounded-lg"
                >
                  v1.0.4-stable
                </span>
              </div>
            ...
            <a
              href="/calculator"
              className="block p-8 bg-primary/5 border border-primary/20 rounded-[2.5rem] hover:bg-primary/10 transition-all group"
            >
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-black text-lg mb-1">Open Calculator</h3>
                  <p className="text-sm text-gray-500">
                    Return to the macro engine
                  </p>
                </div>
