  ...
  return (
    <div className={`grid grid-cols-3 gap-2 ${isCompact ? "mb-4" : "mb-6"}`}>
      {macros.map((macro, i) => (
        <div
          key={i}
          className="bg-white/5 rounded-2xl p-2.5 border border-white/5 flex flex-col items-center justify-center group hover:bg-white/10 transition-all"
        >
          <div
          ...
          <div className="flex flex-col items-center">
            <span className="text-base font-black text-white leading-none tabular-nums">
              {macro.value}
              <span className="text-[8px] text-gray-500 ml-0.5 lowercase font-bold">
                g
              </span>
            </span>
