...
- _Using a library like Decimal.js_: Overkill and adds unnecessary bundle weight for simple macro calculations.
- _Rounding at the state level_: Rejected, as rounding early can lead to cumulative errors when aggregating multiple food items into a meal. Full precision should be kept until the final render.
